...
export default function Home() {
  return (
    ...
    <p className="text-sm">Asteroid Bot est le bot dont votre serveur à besoin, Asteroid Bot est un bot multifonctions polyvalent, prêt à tout pour être ajouté.</p>
    </div>
    </div>
    </div>
    </div>
